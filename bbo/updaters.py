...
from DistributionGaussian import DistributionGaussian
...
class UpdaterMean(Updater):
    ...
    def update_distribution(self, distribution:DistributionGaussian, samples, costs):
        """ Update a distribution with reward-weighted averaging.
        ...
        if distribution.if_clip == True:
            distribution_new.set_range(distribution.upper_limit, distribution.lower_limit)
